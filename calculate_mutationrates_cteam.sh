...
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/454/Vindija/high_cov/Manifesto/Altai/chr${i}_mask.bed.gz -a <( zcat /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/S_Mbuti-2.chr${i}.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo| alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/S_Mbuti-2.map100.chr${i}.bs
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/scratch/fabrizio/Vindija/psmc010616/shuffled_N/Altai.diff.chr${i}.bed.gz -a <( zcat /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/S_Mbuti-2.chr${i}.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo | alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/S_Mbuti-2.mapdiff.chr${i}.bs
