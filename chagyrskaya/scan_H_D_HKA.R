#not finished because probably not useful, since with three genomes scattered in time I really do not have sufficient info for tajima's D.
...
library(data.table)
mydata0<-fread(cmd=paste0('zcat /mnt/scratch/fabrizio/Chagyrskaya/selection/PBS/sims/',myfile,' | grep -v "##"'))

#===========================
# divide in sliding windows
#===========================
