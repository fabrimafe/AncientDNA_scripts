...
winsize_char<-as.character(args[2])
...
resFstAD<-t(sapply(1:(max(cuts)-3),function(x) {
mydata1b<-mydata1[cuts>=x & cuts<=(x+3),]
mydata2b<-mydata2[cuts>=x & cuts<=(x+3),]
mydata1b_allelefreq_normalized<-mydata1_allelefreq_normalized[cuts>=x & cuts<=(x+3)]
mydata2b_allelefreq_normalized<-mydata2_allelefreq_normalized[cuts>=x & cuts<=(x+3)]
...
mydata2b_n<-mydata2_n[cuts>=x & cuts<=(x+3)]
if ( length(nrow(mydata1b))>0 && nrow(mydata1b)>1 ) {
i_toretain<-mydata1b_n!=0 & mydata2b_n!=0
mydata1b<-mydata1b[i_toretain,]
mydata2b<-mydata2b[i_toretain,]
mydata1b_allelefreq_normalized<-mydata1b_allelefreq_normalized[i_toretain]
mydata2b_allelefreq_normalized<-mydata2b_allelefreq_normalized[i_toretain]
mydata1b_n<-mydata1b_n[i_toretain]
mydata2b_n<-mydata2b_n[i_toretain]
if ( length(nrow(mydata1b))>0 && nrow(mydata1b)>1 ) {
return(c(calculate.pairwise.Fst.normalized(rbind(mydata1b[,2]+2*mydata1b[,3],mydata2b[,2]+2*mydata2b[,3]),unname(rbind(mydata1b_n,mydata2b_n))),fst_reich_f(mydata1b[,1],mydata1b[,2]+1,mydata1b[,3],mydata2b[,1],mydata2b[,2]+1,mydata2b[,3]),fst_reich_i(mydata1b[,1],mydata1b[,2]+1,mydata1b[,3],mydata2b[,1],mydata2b[,2]+1,mydata2b[,3]))) 
} else return(c(0,0,0,0,0,0))
} else return(c(0,0,0,0,0,0)) 
...
resFstAN<-t(sapply(1:(max(cuts)-3),function(x) {
mydata1b<-mydata1[cuts>=x & cuts<=(x+3),]
mydata2b<-mydata2[cuts>=x & cuts<=(x+3),]
mydata1b_allelefreq_normalized<-mydata1_allelefreq_normalized[cuts>=x & cuts<=(x+3)]
mydata2b_allelefreq_normalized<-mydata2_allelefreq_normalized[cuts>=x & cuts<=(x+3)]
...
print("finished scan")
rm(data0)
save.image(paste0("/mnt/scratch/fabrizio/Chagyrskaya/selection/PBS/sims/fst/",myfile,".fst_",winsize_char,".RData"))
print(paste("saved data in /mnt/scratch/fabrizio/Chagyrskaya/selection/PBS/sims/fst/",myfile,".fst_",winsize_char,".RData"))
