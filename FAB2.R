...
mylength<-as.numeric(system(paste0("cat /mnt/scratch/fabrizio/Vindija/psmc010616/Manifesto/FAB/calibration/071816/",pop,".",divtime,".myms.tab | wc -l "),intern=TRUE))
mydata<-scan(paste0("/mnt/scratch/fabrizio/Vindija/psmc010616/Manifesto/FAB/calibration/071816/",pop,".",divtime,".myms.tab"),what=character(),n=mylength)
...
write(c(divtime,mean(res[2,]/res[1,]),mean(res[3,]),mean(res[4,]),mean(res[5,]),mean(res[6,])),file=paste0("/mnt/scratch/fabrizio/Vindija/psmc010616/Manifesto/FAB/calibration/071816/",pop,".calibrationFAB"),append=TRUE)
