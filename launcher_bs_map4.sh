...
bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/Altai/all_sites_VCF/chr${i}_mq25.vcf.gz -b <( zcat /mnt/454/Vindija/high_cov/Manifesto/Altai_map35_50/chr${i}_mask.bed.gz | sort -uV -k1,1 -k2,2 ) -sorted -header | vcf2haploidbed 0 | awk -v OFS='\t' '{print $1,$3,$4}' | ~pruefer/src/BamSNPTool/BamSNPAddMaf /mnt/sequencedb/ucsc/goldenPath/hg19/vsPanTro2/axtNet/mafnet/chr$i.hg19.panTro2.net.maf pantro2 | tr '[:lower:]' '[:upper:]' | bs_divergence 3 4 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.Altai.map50.chr${i}.ds
bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/Altai/chr${i}_mq30_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/Altai/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0 | awk -v OFS='\t' '{print $1,$3,$4}' | ~pruefer/src/BamSNPTool/BamSNPAddMaf /mnt/sequencedb/ucsc/goldenPath/hg19/vsPanTro2/axtNet/mafnet/chr$i.hg19.panTro2.net.maf pantro2 | tr '[:lower:]' '[:upper:]' | bs_divergence 3 4 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.Altai.map99.chr${i}.ds; fi
