...
echo $i
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs18 | wc -l); if [ $MYCOUNT -lt 1 ]; then
...
alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs18; fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs19 | wc -l); if [ $MYCOUNT -lt 1 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 60) -sorted -wo |
alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs19; fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs20 | wc -l); if [ $MYCOUNT -lt 1 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 60) -sorted -wo |
only_transversions 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs20;fi
...
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs22 | wc -l); if [ $MYCOUNT -lt 1 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 60) -sorted -wo |
only_transversions 16 21 | only_transversions 6 16 |alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs22;fi
done
i=X
echo $i
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs18 | wc -l); if [ $MYCOUNT -lt 1 ]; then
