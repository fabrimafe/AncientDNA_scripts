...
echo $i
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs23 | wc -l); if [ $MYCOUNT -lt 1 ]; then
...
only_transversions 16 21 | only_transversions 6 16 |alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs23;fi
done
i=X
echo $i
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bs23 | wc -l); if [ $MYCOUNT -lt 1 ]; then
