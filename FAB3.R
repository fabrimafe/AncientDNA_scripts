...
mylength<-as.numeric(system(paste0("cat /mnt/scratch/fabrizio/Vindija/FAB/calibration/110516/",pop,".",divtime,".myms.tab | wc -l "),intern=TRUE))
mydata<-scan(paste0("/mnt/scratch/fabrizio/Vindija/FAB/calibration/110516/",pop,".",divtime,".myms.tab"),what=character(),n=mylength)
...
write(paste(c(divtime,mean(res[2,]/res[1,]),mean(res[3,]),mean(res[4,]),mean(res[5,]),mean(res[6,])),collapse=" "),file=paste0("/mnt/scratch/fabrizio/Vindija/FAB/calibration/110516/",pop,".calibrationFAB"),append=TRUE)
