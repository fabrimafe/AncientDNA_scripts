...
#========================================================================Check PSMC=========================================================================
#===========================================================================================================================================================
#GENERATE INPUT (myvcf2fq) by filling missing data in vcf with A rather than with n, in order to avoid fq2psmcfa to fail
...
bedtools intersect -b $FINALBED -a <(zcat /mnt/scratch/fabrizio/Vindija/header.gz $MYVCF ) -sorted | myvcf2fq_gen_fill $MYQUALITY > $MYOUTPUTFOLDER/temp.$POP.$i.fq
bedtools intersect -b $FINALBED -a <(zcat /mnt/scratch/fabrizio/Vindija/header.gz $MYVCF ) -sorted | myvcf2fq_qual_fill $MYQUALITY >> $MYOUTPUTFOLDER/temp.$POP.$i.fq
