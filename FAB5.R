...
myi<-as.numeric(args[1])
#divtime<-0
#pop<-"D"
#pop<-"S_Khomani_San-1.qual2"
mylength<-as.numeric(system(paste0("cat /mnt/scratch/fabrizio/Vindija/testsameindividual/sim",myi,".tab | wc -l "),intern=TRUE))
mydata<-scan(paste0("/mnt/scratch/fabrizio/Vindija/testsameindividual/sim",myi,".tab"),what=character(),n=mylength)
