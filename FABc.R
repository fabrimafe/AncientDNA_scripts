...
mylength<-as.numeric(system(paste0("cat /mnt/scratch/fabrizio/Vindija/FAB/calibration/120616/",pop,".",divtime,".myms.tab | wc -l "),intern=TRUE))
mydata<-scan(paste0("/mnt/scratch/fabrizio/Vindija/FAB/calibration/120616/",pop,".",divtime,".myms.tab"),what=character(),n=mylength)
