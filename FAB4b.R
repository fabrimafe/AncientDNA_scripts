...
divtime<-as.character(args[2])
#divtime<-0
#pop<-"D"
#pop<-"S_Khomani_San-1.qual2"
mylength<-as.numeric(system(paste0("cat /mnt/scratch/fabrizio/Vindija/FAB/calibration/120616/",pop,"_",divtime,".myms.tab | wc -l "),intern=TRUE))
mydata<-scan(paste0("/mnt/scratch/fabrizio/Vindija/FAB/calibration/120616/",pop,"_",divtime,".myms.tab"),what=character(),n=mylength)
...
write(paste(c(divtime,mean(res[2,]/res[1,],na.rm=TRUE),mean(res[3,]),mean(res[4,]),mean(res[5,]),mean(res[6,])),collapse=" "),file=paste0("/mnt/scratch/fabrizio/Vindija/FAB/calibration/120616/",pop,".calibrationFAB"),append=TRUE)
