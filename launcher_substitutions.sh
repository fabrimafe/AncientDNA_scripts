...
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_AG 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAG;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAT | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_AT 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAT;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAC | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_AC 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAC;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCG | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_CG 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCG;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCT | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_CT 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCT;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCA | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_CA 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsCA;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGC | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_GC 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGC;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGT | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_GT 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGT;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGA | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_GA 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsGA;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTC | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_TC 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTC;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTG | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_TG 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTG;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTA | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
only_transition3_TA 6 16 21 | alternative_bs_othersequal5 16 21 5 6 7 8 9 > /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsTA;fi
done
i=X
echo $i
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/M0.${MYPOP}.chr${i}.bsAG | wc -l); if [ $MYCOUNT -lt 2 ]; then
