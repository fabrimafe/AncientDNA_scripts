...
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/454/Vindija/high_cov/Manifesto/Altai/chr${i}_mask.bed.gz -a <( zcat /mnt/454/Vindija/high_cov/genotypes/Altai/chr${i}_mq25_mapab100.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo| alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/Altai.map100.chr${i}.bs
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/scratch/fabrizio/Vindija/psmc010616/shuffled_N/Altai.diff.chr${i}.bed.gz -a <( zcat /mnt/454/Vindija/high_cov/genotypes/Altai/all_sites_VCF/chr${i}_mq25.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo | alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/Altai.mapdiff.chr${i}.bs
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/454/Vindija/high_cov/Manifesto/Altai/chr${i}_mask.bed.gz -a <( zcat /mnt/454/Vindija/high_cov/genotypes/Altai/chr${i}_mq25_mapab100.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo | only_transversions 5 13 | alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/Altai.transv.map100.chr${i}.bs
bedtools intersect -a <( zcat /mnt/scratch/fabrizio/bonobo/mutrate/ape_table.chr${i}.bed.gz  | grep -v Error ) -b <( bedtools intersect -b /mnt/scratch/fabrizio/Vindija/psmc010616/shuffled_N/Altai.diff.chr${i}.bed.gz -a <( zcat /mnt/454/Vindija/high_cov/genotypes/Altai/all_sites_VCF/chr${i}_mq25.vcf.gz | vcf2haploidbed 0) -sorted) -sorted -wo | only_transversions 5 13 | alternative_bs_othersequal5 13 13 5 6 7 5 5 >  /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/Altai.transv.mapdiff.chr${i}.bs
