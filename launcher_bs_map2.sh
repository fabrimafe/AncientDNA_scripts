...
MYPOP=$1
i=$2
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.${MYPOP}.map${filt}.chr${i}.ds | wc -l); if [ $MYCOUNT -lt 2 ]; then
bedtools intersect -a <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | bs_divergence 4 8 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.${MYPOP}.map${filt}.chr${i}.ds; fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dsC | wc -l); if [ $MYCOUNT -lt 2 ]; then
...
bs_divergence 21 5 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dsC;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dsB | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
bs_divergence 21 6 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dsB;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.${MYPOP}.chr${i}.dsC | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
bs_divergence 21 16 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.${MYPOP}.chr${i}.dsC;fi
MYCOUNT=$( cat /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dshg19C | wc -l); if [ $MYCOUNT -lt 2 ]; then
nohup bedtools intersect -a <( bedtools intersect -a <(zcat /mnt/scratch/fabrizio/Vindija/mutrate/ape_table.chr${i}.bed.gz | grep -v Error) -b <(zcat /mnt/scratch/fabrizio/Vindija/header.gz /mnt/sequencedb/gendivdata/2_genotypes/human/SGDP/release_initial/vcfs/B_Mbuti-4.chr${i}.vcf.gz | vcf2haploidbed 0 ) -sorted -wo | awk '{if (NF==17){print}}') -b <( bedtools intersect -a /mnt/454/Vindija/high_cov/genotypes/${MYPOP}/chr${i}_mq25_mapab100.vcf.gz -b /mnt/454/Vindija/high_cov/Manifesto/${MYPOP}/chr${i}_mask.bed.gz -sorted -header | vcf2haploidbed 0) -sorted -wo |
bs_divergence 5 4 > /mnt/scratch/fabrizio/Vindija/branchshortening/Manifesto/M0.filt99${MYPOP}.chr${i}.dshg19C;fi
